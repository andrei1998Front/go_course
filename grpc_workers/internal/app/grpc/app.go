...
import (
	...
	wrkrsgrpc "github.com/andrei1998Front/grpc_workers_server/internal/grpc"
...
func New(
	log *slog.Logger,
	wrkrsService wrkrsService.EmployeeService,
	port int,
) *App {
	...
	wrkrsgrpc.Register(gRPCServer, wrkrsService)
